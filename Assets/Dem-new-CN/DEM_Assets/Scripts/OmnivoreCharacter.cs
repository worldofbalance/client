...
// This needs to be made a component of the omnivore prefab.
// This lets the species and enemy interact.

public class OmnivoreCharacter : MonoBehaviour {
	private int _health;

	// when the omnivore species is initialized (created), set its health value to 5
	void Start() {
		_health = 5;
	}
